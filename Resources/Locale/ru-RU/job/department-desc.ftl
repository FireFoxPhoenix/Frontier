...
﻿department-Cargo-description = Заполните настители, зарабатывайте Spessos и закажите полезные материалы для экипажа.
department-CentralCommand-description = Управляйте экипажем и держите их эффективно работать.
department-Silicon-description = Слушайте свои законы и служите команде.
