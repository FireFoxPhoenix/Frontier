...
uplink-access-breaker-desc = Взломный конфигуратор доступа и хороший друг EMAG. Это устройство может открыть воздушные шлюзы, а также стирать требования к доступу из оборудования станции. Пополняет автоматически.
...
uplink-antimov-law-desc = Очень опасный законодательство, которое нужно использовать, когда вы хотите вызвать A.I. Чтобы уйти, использовать с осторожностью.
uplink-radio-implanter-desc = Имплантаты синдикат радио, позволяющее скрытую связь без гарнитуры.
