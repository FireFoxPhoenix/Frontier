...
spellbook-upgrade-jaunt-description = Позволяет улучшить Эфирную прогулку до максимального 3-го уровня!spellbook-knock-name = Поступить
spellbook-knock-desc = Открывает все воздушные шлюзы, ящики и шкафчики поблизости.
