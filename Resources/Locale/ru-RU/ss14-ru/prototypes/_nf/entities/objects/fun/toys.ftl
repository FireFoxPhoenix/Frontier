...
ent-NFPlushieEngineer = плюшевый унатх инженер
  .desc = Бедняжка просто сидит и ничего не делает! Обними его, приподними, поцелуй и заставь уже наконец сделать этот чёртов ТЭГ!ent-PlushieSlips = Дворник плюши
ent-DBToySword = игрушечная двойное слово
ent-PlushieTrystan = Офис вульп плюши
ent-PlushieSlips = Дворник плюши
