...
ent-VendingMachineRestockCiviMedVend = набор пополнения МедВенд
    .desc = Ящик, содержащий различные медикаменты для пополнения автомата МедВенл. Надпись на этикетке гласит: "КОРОБКА ЗАЩИЩЕНА ОТ НЕСАНКЦИОНИРОВАННОГО ДОСТУПА, ЕЁ СОДЕРЖИМОЕ БУДЕТ УНИЧТОЖЕНО ПРИ ПОПЫТКЕ ВСКРЫТИЯ".
<<<<<<< Updated upstream
=======
