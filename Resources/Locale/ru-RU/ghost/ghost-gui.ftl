...
ghost-gui-toggle-lighting-manager-popup-personal-light = Персональный свет.
...
ghost-gui-toggle-ghost-visibility-popup-off = Инвалидная видимость призраков.
ghost-roles-window-available-button = Доступен ({$ rolescount})
