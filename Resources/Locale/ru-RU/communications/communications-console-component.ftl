...
comms-console-menu-broadcast-button-tooltip = Проведите свое сообщение на экраны, установленные на стене вокруг сектора. Примечание: они подходят только десять персонажей!
...
comms-console-announcement-title-station-ai = Станция AI
