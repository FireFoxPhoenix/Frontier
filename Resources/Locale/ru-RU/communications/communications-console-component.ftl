...
comms-console-menu-alert-level-button-tooltip = Изменить уровень тревоги в секторе. Применяется немедленно после выбора.
comms-console-menu-emergency-shuttle-button-tooltip = Вызывает или отзывает аварийный шаттл. Отзыв возможен только при наличии достаточного времени.
