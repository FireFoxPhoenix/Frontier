...
command-mailto-completion-recipient = <Получатель EntityUID>
command-mailto-completion-container = <Содержимое EntityUID>
command-mailto-completion-fragile = [IS-Fragile: True | Неверно]
command-mailto-completion-priority = [Is-Priority: True | Неверно]
