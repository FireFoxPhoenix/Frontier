...
borg-type-generic-desc = Мастер на все руки, но мастер без рук. Выполняет различные случайные задачи на станции или помогает научному отделу, создавшему вас.
borg-type-generic-transponder = обычный киборг
borg-type-engineering-name = Инженерный
borg-type-engineering-desc = Помогает инженерной команде в строительстве станции, устранении повреждений, починке электро- и атмосферных систем.
...
borg-type-mining-transponder = добывающий киборг
borg-type-janitor-name = Уборщик
borg-type-janitor-desc = Поддерживайте чистоту станции, убирайте разливы, собирайте и утилизируйте мусор, оставленный ленивыми членами экипажа.
