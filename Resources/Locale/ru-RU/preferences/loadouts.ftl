...
loadout-name-edit-tooltip = Не более 32 символов. Если имя не указано, оно будет выбрано случайным образом.
loadout-name-edit-label-dataset = Устанавливает пользовательское имя, которое будет использоваться, если вы играете за эту роль. Если имя не указано, оно будет выбрано случайным образом.
