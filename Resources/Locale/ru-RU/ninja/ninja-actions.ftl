...
ninja-cell-downgrade = Костюм примет только новую силовую ячейку, которая лучше, чем текущая!
ninja-cell-too-large = Этот источник питания не вписывается в костюм ниндзя!
