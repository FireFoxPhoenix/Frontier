...
bounty-item-tooth-sharkminnow = Sharkminnow зуб
bounty-description-cardboard-box = «Cardborgs Cometheth» - это новая премьера Play Premiering завтра, и костюма очень не готова. Отправьте нам несколько коробок для работы.
bounty-description-flashes = Приветствия \ [Станция] Мы требуем 6 вспышек из -за нормального \ [TrainingExcise] с безопасностью. Все \ [нормально].
bounty-description-tooth-space-carp = Некоторым ребятам из «Down unda» нужны зубы, чтобы сделать свою традиционную одежду. Отправьте им несколько с какого -то космического карпа.
bounty-description-tooth-sharkminnow = Шеф-повар утверждает, что зубы Sharkminns-это своего рода высококачественный нож. Я не знаю, о чем они, но они хотят сет. Отправьте им им.
