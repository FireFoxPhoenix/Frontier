...
bounty-item-tooth-sharkminnow = Зуб акульки
bounty-description-cardboard-box = "Картонкиберы Грядут" – новая пьеса завтрашней премьеры, и костюмерная команда отчаянно не готова. Пришлите нам коробки для работы.
bounty-description-flashes = ПРИВЕТСТВУЕМ [СТАНЦИЮ]. НУЖНО 6 ФЛЕШЕЙ ДЛЯ СТАНДАРТНОГО [УЧЕНИЯ] С ОХРАНОЙ. ВСЁ В НОРМЕ.
...
bounty-description-tooth-sharkminnow = Шеф говорит, что зубы акульки – это тип качественных ножей. Не знаю, о чём он, но ему нужен набор. Присшлите.
