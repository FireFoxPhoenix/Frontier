...
signal-port-description-timer = Запускает график таймера устройства.
...
signal-port-description-logic-enable = Загружает входной сигнал в ячейку памяти только при высоком.
