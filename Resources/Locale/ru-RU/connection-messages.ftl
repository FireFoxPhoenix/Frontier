...
whitelist-notes = В настоящее время у вас есть слишком много заметок администратора, чтобы присоединиться к этому серверу. Вы можете проверить свои заметки, вводив /администраторы в чате.
whitelist-manual = Вы не белилистикуете на этом сервере.
whitelist-blacklisted = Вы в черном списке с этого сервера.
whitelist-always-deny = Вам не разрешено присоединиться к этому серверу.
...
ipintel-server-ratelimited = Этот сервер использует систему безопасности с внешней проверкой, которая достигла своего максимального предела проверки. Пожалуйста, свяжитесь с командой администрации сервера для получения помощи и попробуйте позже.
ipintel-unknown = Этот сервер использует систему безопасности с внешней проверкой, но он столкнулся с ошибкой. Пожалуйста, свяжитесь с командой администрации сервера для получения помощи и попробуйте позже.
...
hwid-required = Ваш клиент отказался отправлять аппаратный идентификатор. Пожалуйста, свяжитесь с командой администрации для получения дополнительной помощи.
