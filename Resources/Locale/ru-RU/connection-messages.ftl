...
whitelist-playtime = У вас недостаточно игрового времени для присоединения к этому серверу. Вам нужно как минимум {$minutes} минут игрового времени.
whitelist-player-count = В настоящее время сервер не принимает новых игроков. Пожалуйста, попробуйте позже.
whitelist-notes = У вас слишком много административных заметок для присоединения к этому серверу. Вы можете проверить свои заметки, введя /adminremarks в чат.
whitelist-manual = Вы не в белом списке этого сервера.
...
hwid-required = Ваш клиент отказался отправить аппаратный идентификатор. Пожалуйста, свяжитесь с администрацией для дальнейшей помощи.
