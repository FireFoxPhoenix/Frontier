...
The current round is: [color = белый]#{$ goodd} [/color]
The current player count is: [color = белый] {$ playercount} [/color]
The current map is: [color = White] {$ mapName} [/color]
The current game mode is: [color = белый] {$ gmtitle} [/color]
The current round is: [color = белый]#{$ goodd} [/color]
The current player count is: [color = White] {$ playercount} [/color] ([цвет
The current map is: [color = White] {$ mapName} [/color]
The current game mode is: [color = белый] {$ gmtitle} [/color]
latejoin-arrival-announcement-special = {$ job} {$ символ} на палубе!
latejoin-arrivals-dumped-from-shuttle = Таинственная сила не позволяет вам уйти с шаттлом прибытия.
latejoin-arrivals-teleport-to-spawn = Таинственная сила телепортирует вас от шаттла. Способи!
game-run-level-PreRoundLobby = Предварительно раундовый лобби
