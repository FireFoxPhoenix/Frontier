...
latejoin-arrivals-dumped-from-shuttle = Таинственная сила мешает вам покинуть станцию на шаттле прибытия.
latejoin-arrivals-teleport-to-spawn = Таинственная сила телепортирует вас с шаттла. Удачной смены!
