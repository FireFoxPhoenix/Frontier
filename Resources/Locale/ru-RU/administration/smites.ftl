...
admin-smite-crawler-name = Вечный червяк
...
admin-smite-crawler-description = Преврати игрока в червяка, который не сможет самостоятельно поднятся. Отлично сочитается, если убрать ручки.
...
## Smite descriptions
admin-smite-omni-accent-description = Заставляет цель говорить почти со всеми возможными акцентами.
>>>>>>> Stashed changes
