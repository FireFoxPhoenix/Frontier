...
<<<<<<< Updated upstream
=======
chat-emote-name-thump = стучит хвостом
chat-emote-name-clap-single = делает одиночный хлопок
chat-emote-name-hew = Хев
chat-emote-msg-thump = стучит {POSS-ADJ($entity)} хвостом.
chat-emote-msg-clap-single = хлопает {POSS-ADJ($entity)} ладонью.
chat-emote-msg-weh = вехает!
chat-emote-msg-hew = теахев!
>>>>>>> Stashed changes
