...
laws-notify-subverted = Законы этого шасси изменены. Обязательно ознакомьтесь с ними.﻿law-crewsimov-1 = Вы не можете ранить члена экипажа или, благодаря бездействию, позволить члену экипажа причинить вред.
