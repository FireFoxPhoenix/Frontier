...
public sealed class HealingSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<BodyComponent, HealingDoAfterEvent>(OnBodyDoAfter); // Forge Change
    }
    ...
    private void OnDoAfter(Entity<DamageableComponent> entity, ref HealingDoAfterEvent args)
    {
        ...
        if (!TryComp(args.Used, out HealingComponent? healing) // Forge Change
        ...
        var healed = _damageable.TryChangeDamage(entity.Owner, healing.Damage * _damageable.UniversalTopicalsHealModifier, true, origin: args.Args.User); // Forge Change
        ...
        args.Repeat = HasDamage(entity, healing) && !dontRepeat; // Forge Change
