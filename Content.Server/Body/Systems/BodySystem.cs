...
public sealed partial class BodySystem : SharedBodySystem // Forge-Change: made partial
{
    [Dependency] private readonly BloodstreamSystem _bloodstream = default!; // Forge-Change
    [Dependency] private readonly GhostSystem _ghostSystem = default!;
    [Dependency] private readonly IGameTiming _gameTiming = default!;
    [Dependency] private readonly HumanoidAppearanceSystem _humanoidSystem = default!;
    [Dependency] private readonly SharedAppearanceSystem _appearance = default!; // Forge-Change
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<BodyPartComponent, AttemptEntityGibEvent>(OnGibTorsoAttempt); // Forge-Change
    }
        ...
        string slotId)
    {
        ...
        if (layer != null)
        {
            ...
            _humanoidSystem.SetLayersVisibility(bodyEnt.Owner, new[] { layer.Value }, visible: true); // Forge-Change
        }
    }
        ...
        string slotId)
    {
        ...
        _appearance.SetData(bodyEnt, layer, true); // Forge-Change
    }
        ...
        List<string>? excludedContainers = null)
    {
        ...
        var gibs = base.GibBody(bodyId, gibOrgans, body, launchGibs: launchGibs, splatDirection: splatDirection,
            ...
            allowedContainers: allowedContainers, excludedContainers: excludedContainers); // Forge-Change
