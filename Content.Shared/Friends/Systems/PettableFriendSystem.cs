...
using Content.Shared._Shitmed.Spawners.EntitySystems; // Forge Change
...
public sealed class PettableFriendSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<PettableFriendComponent, SpawnerSpawnedEvent>(OnSpawned); // Forge Change
    }
