...
public abstract partial class SharedHandsSystem
{
    ...
    public virtual void AddHand(EntityUid uid, string handName, HandLocation handLocation, HandsComponent? handsComp = null)
    {
        ...
        AddToSortedHands(handsComp, handName, handLocation); // Forge Change
    ...
    /// <summary>
    /// Forge Change: This function checks when adding a hand for symmetries to determine where to add it in the sorted hands array.
    /// </summary>
